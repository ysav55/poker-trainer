/* FeltSide · Coach Sidebar v3 — dev fixture.
   Phase 0 default. Phase 1 will replace with state shaped from useSocket. */

export const SIDEBAR_V3_DATA = {
  gameState: {
    hand_number: 142,
    phase: 'flop',
    pot: 420,
  ...
  actionTimer: { playerId: 'me', duration: 25000, remaining: 18700 },
  ...
  equityData: {
    ...
    colors: { u_me: '#f0d060', u_p1: '#6aa8ff', u_p2: '#9b7cff', u_p3: '#4ad991' },
  },
  ...
  tableAggregate: {
    hands: 142, minutes: 87,
    biggestPot: 1840, avgPot: 312,
    showdownRate: 28, bb100: null,
  },

  playerHistory: {
    u_me: { stableId: 'u_me', name: 'Ariela',     isHero: true,
    ...
    u_p1: { stableId: 'u_p1', name: 'Ido Amir',
      stats: { hands: 142, vpip: 31, pfr: 14, bb100: -4.2, wonAtSd: 44, net: -780 },
      handIds: [142,141,140,139,138,137,136,135,134,133,132,131,130,129,128,127,126,125,124,123] },
    u_p2: { stableId: 'u_p2', name: 'Guy Hirsch',
    ...
    u_p3: { stableId: 'u_p3', name: 'Noa Levin',
      stats: { hands: 142, vpip: 38, pfr: 28, bb100: -8.0, wonAtSd: 39, net: -1640 },
      handIds: [142,141,140,139,138,137,136,135,134,133,132,131,130,129,128,127,126,125,124,123] },
    u_p4: { stableId: 'u_p4', name: 'Tal',        isBot: true,
